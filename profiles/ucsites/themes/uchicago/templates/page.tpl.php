...
<div id="footer-wrapper"><div class="container_12">
	<div id="footer" class="clearfix">
		<div class="grid_3">
			<p><a href="<?php print $secure_login; ?>" id="loginlink">&copy;</a> <?php echo date("Y") ?> <a href="http://www.uchicago.edu/">The University of Chicago</a><br /><a href="/"><?php print $site_name; ?></a></p>
