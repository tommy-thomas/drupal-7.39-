...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <link rel="shortcut icon" type="image/x-icon" href="https://www.uchicago.edu/favicon.ico" />
	...
	*/
	-->
  <link rel="stylesheet" media="screen and (min-width: 601px)" href="https://identity.uchicago.edu/c/fonts/proximanova.css" />
  <!--[if lt IE 7]>
  ...
  <script type="text/javascript">
  	...
  	document.documentElement.className += ' fuocjs';
  </script>
