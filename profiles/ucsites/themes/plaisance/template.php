 ...
 *   plaisance_. For example:
 *
 *     original, found in modules/field/field.module: theme_field()
 *     theme override, found in template.php: plaisance_field()
 *
 ...
 */
function plaisance_preprocess_page(&$variables, $hook) {
  // Define some basic variables and set default values
  $variables['theme_name'] = variable_get('theme_default', 'none'); // Get the theme name (used to make small markup swaps for BSD in page.tpl.php)
 ...
 */
function plaisance_preprocess_node(&$variables, $hook) {
 ...
 */
function plaisance_field($variables) {
  $output = '';
 ...
 */
function plaisance_field__taxonomy_term_reference($variables) {
 ...
 */
function plaisance_preprocess_toolbar(&$variables) {
 ...
 */
function plaisance_form_content_access_page_alter(&$form, &$form_state, $form_id) {
 ...
 */
function plaisance_preprocess_image(&$variables) {
  // Strip away width and height attributes so that images respond better
  if (isset($variables['style_name']) && $variables['style_name'] != 'homefeature' && $variables['style_name'] != 'slideshow-larger' && $variables['style_name'] != 'homefeature-large' && $variables['style_name'] != 'columnwidth-wider') {
...
function plaisance_feed_icon($variables) {
 ...
 * Implements hook_form_alter().
 */
function plaisance_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function plaisance_preprocess_comment_wrapper(&$variables) {
  $this_page = current_path();
...
function plaisance_preprocess_maintenance_page(&$variables, $hook) {
  // When a variable is manipulated or added in preprocess_html or
  // preprocess_page, that same work is probably needed for the maintenance page
  // as well, so we can just re-use those functions to do that work here.
  plaisance_preprocess_html($variables, $hook);
  plaisance_preprocess_page($variables, $hook);
}
// */
 ...
 */
function plaisance_preprocess_html(&$variables, $hook) {
 ...
 */
function plaisance_preprocess_securesite_page(&$variables) {
 ...
 */
/* -- Delete this line if you want to use this function
function plaisance_preprocess_comment(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function plaisance_preprocess_region(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function plaisance_preprocess_block(&$variables, $hook) {
