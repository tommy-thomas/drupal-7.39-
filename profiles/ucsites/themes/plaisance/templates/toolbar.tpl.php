...
<?php
  ...
  foreach($user->roles as $rid => $role){
    ...
    if($role == 'accounts administrator'){
      $accounts_admin = TRUE;
    }
...
?>
<?php if(!$sitedev && !$admin && !$accounts_admin && !$account_owner && ($owner || $editor || $contributor)): // If not an admin of some sort, print the custom toolbar ?>
...
<?php else: // Otherwise, print the regular toolbar ?>
  <div id="toolbar" class="<?php print $classes; ?> clearfix">
    <div class="toolbar-menu clearfix">
