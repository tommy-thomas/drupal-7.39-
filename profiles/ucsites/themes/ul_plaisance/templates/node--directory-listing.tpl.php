...
/**
 * @file
 * Node template for directory listings.
 *
 * Available variables:
 ...
 */
?>
<?php $content['field_rightimage'][0]['#image_style'] = 'directoryimage'; // Set the image style here so that the old theme does not break ?>

<article class="node-<?php print $node->nid; ?> <?php print $classes; ?> clearfix"<?php print $attributes; ?>>

  <?php if ($view_mode == 'expanded' || $view_mode == 'compact'): ?>
    
    <?php print render($title_suffix); // Display contextual links ?>
  ...
  <?php else: ?>  
    ...
    <div class="content clearfix"<?php print $content_attributes; ?>>
      ...
      <?php if (!empty($content['field_directoryemailaddress'])): ?>
        <p class="email"><a href="mailto:<?php print render($content['field_directoryemailaddress']['#items'][0]['email']); ?>"><?php print render($content['field_directoryemailaddress']['#items'][0]['email']); ?></a></p>
      <?php endif; ?>
      <?php print render($content['field_directoryfullbio']); ?>
      <?php if ($logged_in && $is_admin && ($view_mode == 'full')): // If user is logged in, print the node URL ?>
        <p class="notes"><a href="/directories">View all of your directories</a>.<br /><br />
        <strong>NOTE:</strong> The short biography is visible only on the directory page. This page displays only the full biography.<br /><br />
