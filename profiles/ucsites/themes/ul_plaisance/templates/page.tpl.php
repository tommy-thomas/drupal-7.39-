...
$interior_features_slideshow = views_embed_view('interior_features', 'block');

if ($feature_block || $home_features_region || $interior_features_region || $interior_features_slideshow ) {
  ...
  <div class="container page <?php print $features_alignment; ?>" role="main">
    <div class="row">
      ...
      <?php if (!$is_blog): ?>
        ...
        <?php if ($feature_block || $home_features_region || $interior_features_region || $interior_features_slideshow): ?>
          <div id="features-outer" class="content-column">
            <?php print $interior_features_slideshow; ?>
